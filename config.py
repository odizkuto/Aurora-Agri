...
class Config:
    ...
    SECRET_KEY = os.environ.get("SECRET_KEY", "aurora-dev-secret-key")
    ...
    #   MAIL_SENDER_NAME=Aurora Agri
    #   APP_BASE_URL=https://aurora-agri.onrender.com
    RESEND_API_KEY = os.environ.get("RESEND_API_KEY", "")
    MAIL_FROM_EMAIL = os.environ.get("MAIL_FROM_EMAIL", "onboarding@resend.dev")
    MAIL_SENDER_NAME = os.environ.get("MAIL_SENDER_NAME", "Aurora Agri")
    ...
    #   ADMIN_EMAILS=admin@auroraagri.com,owner@gmail.com
