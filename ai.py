...
FOUNDER_KEYWORDS = [
    ...
    "người tạo ra aurora", "aurora của ai",
]
...
def chat_with_ai(message, history=None, image_path=None):
    ...
    model = genai.GenerativeModel(
        GEMINI_MODEL,
        system_instruction=(
            "Bạn là trợ lý AI nông nghiệp của Aurora Agri, trả lời ngắn gọn, hữu ích, bằng tiếng Việt. "
...
def fetch_plant_image(query):
    ...
    try:
        ...
        resp = requests.get(
            ...
            timeout=6,
            headers={"User-Agent": "AuroraAgri/1.0 (plant library search)"},
        )
        data = resp.json()
